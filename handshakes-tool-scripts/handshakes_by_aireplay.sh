...
do
	if [ -z "${inface_num}" ] || [ "${inface_num}" == "" ]; then
		...
		clear
		show_interface_list
		echo -e "\033[3Inface_num kann nicht 0 sein\033[0m"
		echo -ne "\033[33mBitte wählen Sie eine Schnittstelle: \033[0m"
		read inface_num
		...
		clear
		show_interface_list
		echo -e "\033[31mInface_num muss kleiner sein als die Gesamtzahl der Schnittstellenlist\033[0m"
		echo -ne "\033[33mBitte wählen Sie eine Schnittstelle: \033[0m"
		read inface_num
	else
		break
...
if [ ${card_check_status} -eq 0 ]; then
	echo -e "\033[35mDie von Ihnen gewählte Schnittstelle ist\033[0m \033[32m[${wlan_card}]\033[0m \033[35mwird unterstützt\033[0m"
else
...
if [ ${interface_status} -eq 0 ];then
	...
	if [ ${monitor_check} -ne 0 ]; then
		echo -e "\033[31mPrüfung fehlgeschlagen\033[0m \033[35mSchnittstelle im Monintor Modus starten...\033[0m"
...
sleep 15
echo -e "\033[32mmSchliesse aireplay-ng Angriff xterm...\033[0m"
...
echo -e "\033[31m0.        zurueck zur Tool-Auswahl\033[0m       \033[36m*\033[0m"
echo -e "\033[36m************************************\033[0m"
